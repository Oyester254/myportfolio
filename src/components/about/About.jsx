    ...
    >
      ...
      <div className="w-full sm:flex mx-2 ">
        ...
        <div className="w-full flex flex-col justify-center content-center px-4 py-4">
          ...
          <p className="text-justify sm:text-[15px]  text-[12px] font-bodyFont tracking-tight">
          ...
          <p className="py-8 text-justify sm:text-[15px] text-[12px] font-bodyFont tracking-tight">
